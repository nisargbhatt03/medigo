    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">View sales, inventory and prescription reports.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-slate-800 mt-1">₹4,82,300</p>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-blue-600 mt-1">1,248</p>
        </div>
      </div>
    </div>
  );

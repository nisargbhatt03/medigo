...
export default function PharmaInventory() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Medicine Inventory</h2>
          <p className="text-xs text-slate-500">Manage medicine stock, categories and reorder points.</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-semibold text-slate-800 flex items-center gap-2">
                  <Pill className="w-4 h-4 text-teal-600" /> Crocin 500
                </td>
                <td className="py-3 px-4 text-slate-600">Paracetamol</td>
                <td className="py-3 px-4 text-slate-600">Analgesic</td>
                <td className="py-3 px-4 font-bold text-slate-800">320</td>

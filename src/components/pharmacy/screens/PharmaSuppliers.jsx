...
export default function PharmaSuppliers() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Suppliers</h2>
          <p className="text-xs text-slate-500">Manage medicine suppliers and vendors.</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-semibold text-slate-800 flex items-center gap-2">
                  <Truck className="w-4 h-4 text-blue-600" /> Wellness Pharma
                </td>
                <td className="py-3 px-4 text-slate-700">Rajesh Kumar</td>
                <td className="py-3 px-4 font-mono text-slate-600">+91 98765 43210</td>
                <td className="py-3 px-4 text-slate-600">rajesh@wellness.in</td>

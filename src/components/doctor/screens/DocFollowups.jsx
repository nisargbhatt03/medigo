...
export default function DocFollowups() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Follow-up Management</h2>
          <p className="text-xs text-slate-500">Track and schedule follow-up appointments for patients.</p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-mono text-blue-600">UHD001247</td>
                <td className="py-3 px-4 text-slate-500">Jan 02, 2025</td>

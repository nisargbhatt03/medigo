  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Doctor Settings</h2>
          <p className="text-xs text-slate-500">Manage your preferences and configuration.</p>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-2xs max-w-2xl space-y-4 text-xs">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input type="text" defaultValue="Dr. Priya Sharma" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-slate-800 font-semibold" />
          </div>
          <div>
            <label className="block text-slate-700 font-semibold mb-1">Email</label>
            <input type="email" defaultValue="priya@myclinic.com" className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-slate-800" />
          </div>
        </div>
      </div>
    </div>

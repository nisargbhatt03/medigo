...
import { Plus, FlaskConical, MoreVertical } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Lab Management</h2>
          <p className="text-xs text-slate-500">Manage lab tests, pricing and test categories.</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-slate-800 mt-1">124</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          <p className="text-xs text-slate-500 font-medium">Active</p>
          <p className="text-2xl font-extrabold text-emerald-600 mt-1">118</p>
        </div>
      </div>

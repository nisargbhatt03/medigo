    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Manage clinic departments, services and department heads.</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-semibold text-slate-800 flex items-center gap-2">
                  <Building2 className="w-4 h-4 text-blue-600" /> General Medicine
                </td>
                <td className="py-3 px-4 text-slate-600">Primary care and general health...</td>
                <td className="py-3 px-4 text-slate-700 font-medium">Dr. Priya Sharma</td>
                <td className="py-3 px-4 font-bold text-slate-800">4</td>

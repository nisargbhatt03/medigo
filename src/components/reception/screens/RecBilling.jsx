...
import { Plus, Receipt, TrendingUp, MoreVertical } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500">Create invoices, collect payments and view transaction history.</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-slate-800 mt-1">₹18,320</p>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
          ...
          <p className="text-2xl font-extrabold text-amber-600 mt-1">₹4,300</p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-mono text-blue-600 font-bold">INV-00124</td>
                <td className="py-3 px-4 font-semibold text-slate-800">Rahul Mehta</td>
                <td className="py-3 px-4 font-extrabold text-slate-900">₹2,000</td>
                <td className="py-3 px-4">
                  <span className="bg-emerald-50 text-emerald-700 font-bold px-2 py-0.5 rounded text-[11px]">Paid</span>
                </td>
                <td className="py-3 px-4 text-slate-600">UPI</td>

...
export default function RecDocuments() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-slate-800">Patient Documents</h2>
          <p className="text-xs text-slate-500">Upload and manage patient documents (ID proof, insurance, reports, etc.).</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-3 px-4 font-semibold text-slate-800 flex items-center gap-2">
                  <FileText className="w-4 h-4 text-blue-600" /> Aadhaar Card
                </td>
                <td className="py-3 px-4 text-slate-600">ID Proof</td>
                <td className="py-3 px-4 text-slate-500 font-mono">Jan 10, 2025</td>
                <td className="py-3 px-4 text-slate-700">Reception</td>
